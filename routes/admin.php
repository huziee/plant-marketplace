...
Route::middleware(['auth', 'role:admin,editor,author,nursery_owner'])
    ->prefix('admin')
    ->name('admin.')
    ->group(function () {
        // Admin Dashboard (Accessible to admin, editor, author, nursery_owner)
        Route::get('/', [DashboardController::class, 'index'])->name('dashboard');

        // Admin Only Routes (Users Management, System Settings, Shipping Methods, Pages CMS)
        ...
        // Ecommerce Admin & Nursery Partner Management (Accessible to admin & nursery_owner)
        Route::middleware('role:admin,nursery_owner')->group(function () {
